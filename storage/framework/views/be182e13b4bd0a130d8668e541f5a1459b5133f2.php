        ...
        <div style="width: 30%;" class="mx-auto">
            <div class="card text-end">
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="<?php echo e(route('update-product', ['id' => $product->id])); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="product_title" class="form-label">Product Title</label>
                            <input type="text" name="product_title" class="form-control" id="product_title" value="<?php echo e($product->product_title); ?>">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="1" name="product_base_price" class="form-control" id="product_base_price" value="<?php echo e($product->product_base_price); ?>">
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PlayGround\Laravel\Auction Application\auction_me\resources\views/update-product.blade.php ENDPATH**/ ?>